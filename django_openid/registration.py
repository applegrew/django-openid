...
class RegistrationConsumer(AuthConsumer):
    ...
    # ugettext_lazy cannot be used or mark_user_unconfirmed() will fail
    unconfirmed_group = _('Unconfirmed users')
    ...
    def mark_user_unconfirmed(self, user):
        ...
        user.save()
        group, created = Group.objects.get_or_create(name = self.unconfirmed_group)
